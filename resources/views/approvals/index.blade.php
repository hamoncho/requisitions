<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('approval.requisitions_to_approve') }}
        </h2>
    </x-slot>
    <div class="py-12">
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div id="pending-content" class="tab-content">
                        @if ($requisitions->isEmpty())
                            <p class="py-4">{{ __('approval.not_pending_requisitions') }}</p>
                        @else
                    ...
                    <div id="approved-content" class="tab-content hidden">
                        @if ($approved->isEmpty())
                            <p class="py-4">{{ __('approval.not_approved_requisitions') }}</p>
                        @else
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-gray-50">
                    ...
                    <div id="rejected-content" class="tab-content hidden">
                        @if ($rejected->isEmpty())
                            <p class="py-4">{{ __('approval.not_rejected_requisitions') }}</p>
                        @else
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-gray-50">
