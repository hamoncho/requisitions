<x-app-layout>
    ...
    <div class="max-w-7xl m-auto p-4 sm:p-6">
        ...
        <div
            ...
            <!-- Card alta -->
            <a href="#" class="bg-white shadow rounded-md overflow-hidden flex flex-col sm:row-span-1 md:row-span-2">
                <img class="h-3/4 w-full object-cover"
            ...
            <!-- Card normal -->
            <a href="{{ route('budget_item.index')}}" class="bg-white shadow rounded-md overflow-hidden flex flex-col">
            ...
            <a href="#" class="bg-white shadow rounded-md overflow-hidden flex flex-col">
                <img class="h-3/4 py-4 w-full object-contain" src="{{ asset('/storage/img/cards/contabilidad.png') }}"
                    alt="Card">
                <div class="px-4 content-center flex-1 bg-blue-950">
                    <h3 class="font-semibold text-gray-200 text-sm sm:text-base">{{ __('Budget Item') }}</h3>
                    <p class="text-xs sm:text-sm text-gray-300">{{ __('Manage Budget Item') }}</p>
            ...
            <a href="#" class="bg-white shadow rounded-md overflow-hidden flex flex-col sm:col-span-2">
                <img class="h-3/4 w-full object-contain"
                    src="{{ asset('/storage/img/cards/mejorar-contabilidad-de-la-empresa.jpg') }}" alt="Card">
                <div class="px-4 content-center flex-1 bg-blue-950">
            ...
            <!-- Card normal -->
            <a href="#" class="bg-white shadow rounded-md overflow-hidden flex flex-col">
                <img class="h-3/4 py-4 w-full object-contain"
                    src="{{ asset('/storage/img/cards/mejorar-contabilidad-de-la-empresa.jpg') }}" alt="Card">
                <div class="px-4 content-center flex-1 bg-blue-950">
