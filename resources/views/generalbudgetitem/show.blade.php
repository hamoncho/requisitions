<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('General Budget Item Details') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-lg rounded-lg">
                <div class="p-6 sm:p-8 border-b border-gray-200">
                    <div class="flex flex-col sm:flex-row justify-between items-start">
                        <div>
                            <p class="text-sm font-semibold text-blue-500 uppercase tracking-wider">General Budget Item</p>
                ...
                <div class="p-6 sm:p-8">
                    <h4 class="text-lg font-semibold text-gray-800">Associated Budget Items</h4>
                    <div class="mt-4 flex flex-wrap gap-2">
                        ...
                        @empty
                            <p class="text-gray-500">No budget items for this general budget item.</p>
                        @endforelse
                    </div>
                </div>
            </div>
