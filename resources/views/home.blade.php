        ...
        <div class="pb-8 px-4 mx-auto max-w-screen-xl">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-gray-50 border border-gray-200 rounded-lg p-8 md:p-12">
                    @isset(Auth::user()->requisitions->last()->id)
                        @if(Auth::user()->requisitions->last()->status == 'draft')
                            <a href="{{ route('requisition_items.index', [
                                                                    'requisition' => Auth::user()->requisitions->last()->id,
                                                                    'requisitionItems' => Auth::user()->requisitions->last()->requisitionItems
                                                                  ]) }}"
                ...
                <div class="bg-gray-50  border border-gray-200 rounded-lg p-8 md:p-12">
                    <a href="{{ route('objective.list') }}" class="bg-purple-100 text-purple-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md mb-2">
